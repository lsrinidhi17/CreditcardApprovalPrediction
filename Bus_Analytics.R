...
write.csv2(data,"~/Downloads/Bus Project/newData.csv",append = FALSE)
...
plot(fit, uniform=TRUE, main="Classification Tree for Purple")
...
plot(tune_fit, uniform=TRUE, main="Classification Tree for Months_Balance")
